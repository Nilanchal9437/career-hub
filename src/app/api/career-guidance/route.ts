...
const trainingData: TrainingData[] = [
  {
    ...
    collegeTeachingGaps: [
      ...
      "Not cloud/containerization covered",
      "Barely data/AI/ML",
      "Often statistics excluded",
      "Not soft skills emphasized",
    ],
    marketDemandSkills: [
      "Core + frameworks + clean code practices",
      "Django/FastAPI + REST APIs + databases",
      "pytest, CI/CD, Docker",
      "AWS/GCP basics + Docker",
      "Pandas/NumPy, Scikit-Learn, TensorFlow/PyTorch",
      "Regressions, classification, probability knowledge",
      "Communication, teamwork, critical thinking",
    ],
    technicalRoadmap: [
      "Backend dev: Django or FastAPI + ORM + REST API + testing",
      "Databases: SQL (PostgreSQL/MySQL) + basic NoSQL",
      "Cloud & containers: AWS fundamentals + Docker",
      "AI Data: Pandas, NumPy, Scikit-Learn + similar ML models",
      "Generative AI: Explore tools like UX Pilot API for real-world automation",
    ],
    softSkills: [
      "Git workflows & teamwork",
    ...
    projectIdeas: [
      "Blog or e-commerce backend (Django/FastAPI)",
      "Data dashboard: fetch data — analyze — visualize",
      "Small ML model: classification or regression",
      "Generative AI mini-app: e.g., chatbot or summary tool",
      "API integration project with authentication",
    ],
  },
  {
    etablissement: "ENSA",
    ...
    competences:
      "Développement complet, sécurité, gestion projet, dev web/mobile",
    foundationSkills: [
      "Python deeply + problem solving",
      "Logic Building & OOP",
      "Intro to Data Structures",
    ...
    collegeTeachingGaps: [
      ...
      "Minimal DevOps training",
      "Basic mobile development",
      "Limited testing practices",
    ],
    marketDemandSkills: [
      "Spring Boot/Django frameworks",
    ...
    technicalRoadmap: [
      "Master Java Spring Boot or Python Django",
  ...
  },
  {
    ...
    technicalRoadmap: [
      "Master ML frameworks (TensorFlow, PyTorch)",
  ...
  },
  {
    ...
    competences:
      "Développement logiciel, base de données, architecture logicielle",
    foundationSkills: [
      "Python deeply + problem solving",
      "Logic Building & OOP",
      "Intro to Data Structures",
  ...
  },
  {
    ...
    collegeTeachingGaps: [
      "Limited hands-on cloud experience",
      "Minimal production environment exposure",
  ...
  },
  {
    ...
    collegeTeachingGaps: [
      "Limited real-world threat scenarios",
      "Minimal cloud security experience",
  ...
  },
  {
    ...
    competences:
      "Logique, programmation procédurale, modélisation, simulation, communication",
    foundationSkills: [
    ...
    collegeTeachingGaps: [
      "Limited modern programming languages",
      "Minimal software engineering practices",
  ...
  public findMatchingData(
    ...
    if (!match) {
      ...
      match = trainingData.find((data) =>
        courseKeywords.some(
          (keyword) =>
            courseLower.includes(keyword) &&
            data.filiere.toLowerCase().includes(keyword)
        )
      );
    }
    ...
    return {
      ...
      technicalRoadmapSuggestions: [
        ...
        },
        {
          category: "Backend",
          recommendations: [
            "Learn Node.js or Python Django",
      ...
      nextStepsAction: [
        ...
        },
        {
          ...
          priority: "Critical",
          resources:
            "Job portals, university career services, company websites",
      ...
      personalizedAdvice: {
        ...
        differentiationStrategy: [
          ...
          "Develop bilingual communication",
...
export async function POST(req: NextRequest) {
  ...
  try {
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "Request body is empty. Please send university and course in JSON format.",
          example: {
            universityName: "ENSA",
    ...
    const systemInstruction = jsonGenerator.generateInstruction(
      finalUniversity,
      finalCourse
    );
    const userPrompt = jsonGenerator.generateUserPrompt(
      finalUniversity,
      finalCourse
    );
    ...
    try {
      ...
      let parsedResponse;
      try {
        const cleanedResponse: any = aiResponse?.trim();
        ...
        console.warn(
          "Failed to parse AI response as JSON, using enhanced fallback"
        );
        parsedResponse = jsonGenerator.generateFallbackJSON(
          finalUniversity,
          finalCourse
        );
      }
      ...
      const finalResponse = {
        ...
        metadata: {
          ...
          hasMatchingData:
            jsonGenerator.findMatchingData(finalUniversity, finalCourse) !==
            null,
      ...
      const fallbackResponse = jsonGenerator.generateFallbackJSON(
        finalUniversity,
        finalCourse
      );
...
export async function GET() {
  return NextResponse.json({
    ...
    usage:
      "Send POST request with universityName and courseName in JSON format",
    example: {
      universityName: "ENSA",
      courseName: "Génie Informatique",
    },
